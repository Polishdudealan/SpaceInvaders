...
void Pacman::drawPacman(int frame, Signal& matrix) {
    if (frame % 2 == 0) {
//middle rectangle
        matrix.fillRect(x-14,13,13,5, YELLOW.to_333());
//next rectangles (1) (Up, Down)
        matrix.fillRect(x-13,11,11,2, YELLOW.to_333());
        matrix.fillRect(x-13,18,11,2, YELLOW.to_333());
//next rectangles (2) (Up, Down)
        matrix.fillRect(x-12,10,9,1, YELLOW.to_333());
        matrix.fillRect(x-12,20,9,1, YELLOW.to_333());
//last rectangles (3) (Up, Down)
        matrix.fillRect(x-10,9,5,1, YELLOW.to_333());
        matrix.fillRect(x-10,21,5,1, YELLOW.to_333());

    } else {
//line1 middle to up
        matrix.fillRect(x-13,15,5,1, YELLOW.to_333());
        matrix.fillRect(x-13,14,7,1, YELLOW.to_333());
        matrix.fillRect(x-13,13,10,1, YELLOW.to_333());
//line 1 down to middle thing
        matrix.fillRect(x-13,16,7,1, YELLOW.to_333());
        matrix.fillRect(x-13,17,10,1, YELLOW.to_333());
//other lines top
        matrix.fillRect(x-12,11,11,2, YELLOW.to_333());
        matrix.fillRect(x-11,10,9,1, YELLOW.to_333());
        matrix.fillRect(x-9,9,5,1, YELLOW.to_333());
//other lines bottom
        matrix.fillRect(x-12,18,11,2, YELLOW.to_333());
        matrix.fillRect(x-11,20,9,1, YELLOW.to_333());
        matrix.fillRect(x-9,21,5,1, YELLOW.to_333());
    }
